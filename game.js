...
playGame.prototype = {
    preload: function () {
        ...
        game.load.image("ground", "phaser/assets/sprites/ground.png");
        game.load.image("sky", "phaser/assets/sprites/sky.png");
        game.load.image("crate", "phaser/assets/sprites/crate.png");
    },
    create: function () {
